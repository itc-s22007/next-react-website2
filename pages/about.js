        ...
        <TwoColumnMain>
          <PostBody>
            ...
            <Accordion heading='プログラミングのポイントについて'>
              <p>
                プログラミングのポイントは、作りたいものを作ることです。楽しいことから思いつき、目標とゴールを決め、そこに向かってさまざまな課題を設定していきながら、プログラミングを作って行きます。
              </p>
            </Accordion>
            <Accordion heading='古代語の解読について'>
              <p>
                古代語を解読するのに必要なのは、書かれた文字そのものだけです。古代の世界感や思考方法。それらを読み取ってこそ古代の世界観が理解できてきます。
              </p>
            </Accordion>
